#!/bin/bash
# 2016-09 : Change by GeoHolz https://blog.jolos.fr
...
######       CHANGE LOG        #########
# V2.0:Change MIBs for Eaton SX9
...
print_help(){
    ...
    echo ""
    echo "Description:"
    echo "$PROGNAME is a Nagios plugin to check by snmp a Eaton UPS."
...
#ups oids snmp
oid_upsOutputNumLines='UPS-MIB::upsOutputNumLines.0'
oid_upsInputNumLines='UPS-MIB::upsInputNumLines.0'
oid_upsBatteryTemperature='1.3.6.1.2.1.33.1.2.7.0'
oid_upsOutputPercentLoad='UPS-MIB::upsOutputPercentLoad'
oid_upsBatteryStatus='UPS-MIB::upsBatteryStatus.0'
oid_upsInputVoltage='UPS-MIB::upsInputVoltage'
oid_upsEstimatedChargeRemaining='UPS-MIB::upsEstimatedChargeRemaining.0'
oid_upsEstimatedMinutesRemaining='UPS-MIB::upsEstimatedMinutesRemaining.0'
oid_upsAlarmsPresent='UPS-MIB::upsAlarmsPresent.0'
...
#        ;;
   output_load)
        ...
        then        
            echo "warninig and critical values requiered"   
			echo "use: ./$PROGNAME -H 10.40.80.1 -p output_load -w 80 -c 90"				
            exit
        fi
